$(document).ready(function () {
    ...
    $('.categoria_lista .categoria_item_funcadmin[category="todas"]').addClass('selecionada');
    ...
    $('.categoria_item_funcadmin').click(function (evento) {
        desativaScroll = true;
        evento.preventDefault();
        selecionado = $(this).attr('category');
        ultimoId = 0;
        $('.categoria_item_funcadmin').removeClass('selecionada');
